...
3. Wenn `setting.yaml` einen `flags:`-Block hat, lies `_engine/flags/[flag]/DUNGEON_MASTER.md` für jeden aktiven Flag (falls vorhanden)
...
- Flag-Dateien liegen in `_engine/flags/[flag_name]/[PHASE].md` — ein Unterordner pro Flag
